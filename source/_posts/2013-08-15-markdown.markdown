...
再然后，出现了[jekyllrb][1] 和 [Octopress][2]  这种基于 [github page][5] 和 markdown 的 Blog 框架，使人们摆脱 wordpress 的臃肿，不必担心找不到托管服务器。使用简单的 markdown 语法即可快速的来撰写和发布博客。(当前这个 blog 正是使用 [Octopress][2] + [github page][5] 搭建的博客)
